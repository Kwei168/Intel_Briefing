...
/* Meta info card (applied via JS) */
.article p.meta-card{{background:var(--card);border:1px solid var(--line);border-radius:var(--radius);padding:16px 20px;margin:0 0 28px;font-size:14px;line-height:2;}}
.article p.meta-card strong{{color:var(--muted);font-weight:600;margin-right:6px;font-family:var(--mono);font-size:12.5px;letter-spacing:.02em;}}
.article p.meta-card a{{color:var(--brand-strong);border-bottom:1px solid var(--brand-line);}}
.article p.meta-card a:hover{{border-bottom-color:var(--brand-strong);}}
...
.article h3{{font-family:var(--display);font-size:17px;font-weight:700;margin:24px 0 10px;color:var(--ink);line-height:1.5;}}
...
@media (max-width:700px){{
  ...
  .article p.meta-card{{padding:12px 16px;font-size:13px;line-height:1.9;}}
}}
</style>
...
/* Mark meta info card: first <p> containing <strong> right after <h1> */
(function(){{
